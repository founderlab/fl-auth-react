...
exports['default'] = { actions: _actions2['default'], reducer: _reducer2['default'], LoginForm: _componentsLogin_form2['default'], RegisterForm: _componentsRegister_form2['default'] };
