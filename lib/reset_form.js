...
var ResetForm = (function (_React$Component) {
  ...
  function ResetForm() {
    ...
    this.onSubmit = function (data) {
      ...
      data.email = _this.props.query.get('email');
      data.reset_token = _this.props.query.get('reset_token');
  ...
  ResetForm = (0, _reduxForm.connectReduxForm)({
    form: 'reset',
