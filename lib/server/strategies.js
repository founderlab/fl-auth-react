...
function configureStrategies() {
  ...
  // passport functions
  _passport2['default'].use('login', new _passportLocal.Strategy({ passReqToCallback: true, usernameField: 'email' }, function (req, email, password, callback) {
  ...
  _passport2['default'].use('register', new _passportLocal.Strategy({ passReqToCallback: true, usernameField: 'email' }, function (req, email, password, callback) {
