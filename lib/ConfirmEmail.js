...
var ConfirmEmail = (function (_Component) {
  ...
  function ConfirmEmail() {
    ...
    _classCallCheck(this, _ConfirmEmail);

    _get(Object.getPrototypeOf(_ConfirmEmail.prototype), 'constructor', this).apply(this, arguments);

    this.onSubmit = function (data) {
      data.email = _this.props.email;
      data.email_confirmation_token = _this.props.token;
  ...
  _createClass(ConfirmEmail, [{
    ...
    value: function render() {
      ...
      var error = auth.get('errors') ? auth.get('errors').get('confirm_email') : null;
  ...
  var _ConfirmEmail = ConfirmEmail;
  ConfirmEmail = (0, _reduxForm.reduxForm)({
    form: 'reset',
