...
var RegisterForm = (function (_React$Component) {
  ...
  _createClass(RegisterForm, [{
    ...
    value: function render() {
      ...
      var register_error = this.props.auth.get('register_error');
      var error_msg = process.env.NODE_ENV === 'production' ? 'Uh oh, something went wrong' : (register_error || '').toString();
      ...
      return _react2['default'].createElement(
        ...
        register_error && _react2['default'].createElement(
          'small',
          null,
          error_msg
        ),
